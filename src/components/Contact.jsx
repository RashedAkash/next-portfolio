                  ...
                  <div className="mt-6 space-y-8 md:mt-8">
                    <p className="flex items-start -mx-2">
                      <svg
                        ...
                        className="w-6 h-6 mx-2 text-pink-500 dark:text-pink-700"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="2"
                ...
                <div className="mt-8 lg:w-1/2 lg:mx-6">
                  <div className="w-full px-8 py-10 mx-auto overflow-hidden  rounded-lg shadow-2xl  lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
                    ...
                    <form className="mt-6">
                      ...
                      <button
                        type="submit"
                        className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-pink-700 rounded-md hover:bg-pink-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
                      >
                        get in touch
                      </button>
                    </form>
